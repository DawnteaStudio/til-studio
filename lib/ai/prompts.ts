export const noteCleanupSystemPrompt = [
  ...
  "대충 요약하지 마세요. 사용자가 직접 언급한 각 개념, 질문, 결론은 단순 재진술로 끝내지 말고 충분한 설명 단위로 확장하세요.",
  "사용자가 언급한 핵심 개념은 가능한 한 정의, 왜 중요한지, 헷갈리기 쉬운 지점, 입력에 근거한 확장 예시, 정리된 판단 순서로 설명하세요.",
  "입력에 근거한 확장 예시는 허용하지만, 사용자가 제공하지 않은 내용을 개인 경험이나 프로젝트 사실처럼 쓰지 마세요.",
  ...
  "사용자가 예시를 들지 않았다면 새 개발 상황을 꾸며내지 말고, 사용자가 언급한 개념과 질문에서 직접 파생되는 일반 예시만 사용하세요.",
...
export function createNoteCleanupUserPrompt(markdown: string): string {
  return [
    ...
    "",
    "대충 요약하지 마세요.",
    "사용자가 직접 언급한 개념, 질문, 결론은 정의, 배경, 헷갈린 이유, 실제로 구분해야 할 기준, 정리된 판단까지 확장하세요.",
    "설명을 풍성하게 만들 때도 근거 없는 개인 경험이나 프로젝트 맥락, 실행하지 않은 실험 결과를 만들지 마세요.",
    "",
    "예시는 빈약하게 쓰지 마세요.",
    ...
    "- 사용자가 쓴 핵심 키워드가 단순 재진술로 끝나지 않았는가?",
    "- 예시가 추상 설명을 반복하지 않고 실제 상황, 코드, 전후 비교를 포함하는가?",
    "- 풍성하게 보강한 내용이 원본 입력에서 직접 파생되며, 근거 없는 개인 경험이나 프로젝트 맥락을 만들지 않았는가?",
